...
export class CorpseService {
  ...
  public getAllCorpse(): Observable<Corpse[]> {
    return this.http
      .get<Corpse[]>('http://10.10.50.35:8094/corpses')
  ...
  public addCorpse(corpse: Corpse): Observable<Corpse> {
    if (corpse.id) {
      return this.http.put<Corpse>('http://10.10.50.35:8094/corpse', corpse);
    } else {
      return this.http.post<any>('http://10.10.50.35:8094/corpses', corpse);
    }
  };
}
